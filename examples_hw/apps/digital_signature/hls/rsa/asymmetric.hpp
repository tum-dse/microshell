...
// AXIS beats with rotate-XOR-and-counter mixing (counter defeats
// all-identical inputs); on tlast, lifts the accumulator into Montgomery
// form and computes m^e mod N. updateKey() precomputes rMod = R^2 mod N.
