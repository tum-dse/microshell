...
// Hold host TLAST until the FFT emits its final beat, so downstream sees a single
// end-of-frame marker per host packet rather than the FFT's per-transform TLAST.
