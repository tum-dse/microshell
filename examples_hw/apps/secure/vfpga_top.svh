/**
 * VFPGA Top Module with RLE-AES Pipeline
 *
 */
import lynxTypes::*;
...
// RLE compressor stage (first in pipeline)
rle_top inst_rle (
    .axis_sink (axis_host_sink_int),
    .axis_src (axis_rle_out_int),
    .aclk (aclk),
    .aresetn (aresetn)
);

// AES encryption stage (second in pipeline)
aes_top inst_aes (
