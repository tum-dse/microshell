...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_config_0/user_c0_0/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_user_wrapper_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_user_wrapper_0.tcl
