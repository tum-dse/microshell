...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_config_0/user_c0_0/test.runs/xfft_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_0.tcl
