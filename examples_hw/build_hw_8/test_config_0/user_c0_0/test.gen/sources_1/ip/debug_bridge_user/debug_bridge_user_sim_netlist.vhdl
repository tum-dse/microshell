...
-- Date        : Wed Nov 27 16:34:37 2024
-- Host        : amy running 64-bit NixOS 24.05 (Uakari)
-- Command     : write_vhdl -force -mode funcsim
--               /scratch/anubhav/Coyote/examples_hw/build_hw_8/test_config_0/user_c0_0/test.gen/sources_1/ip/debug_bridge_user/debug_bridge_user_sim_netlist.vhdl
-- Design      : debug_bridge_user
...
entity debug_bridge_user_bd_4611 is
  port (
  ...
  attribute HW_HANDOFF of debug_bridge_user_bd_4611 : entity is "debug_bridge_user.hwdef";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of debug_bridge_user_bd_4611 : entity is "bd_4611";
end debug_bridge_user_bd_4611;

architecture STRUCTURE of debug_bridge_user_bd_4611 is
  component debug_bridge_user_bd_4611_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  end component debug_bridge_user_bd_4611_lut_buffer_0;
  component debug_bridge_user_bd_4611_xsdbm_0 is
  port (
    update : in STD_LOGIC;
  ...
  end component debug_bridge_user_bd_4611_xsdbm_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN bd_4611_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
lut_buffer: component debug_bridge_user_bd_4611_lut_buffer_0
     port map (
...
xsdbm: component debug_bridge_user_bd_4611_xsdbm_0
     port map (
...
entity debug_bridge_user is
  ...
  attribute NotValidForBitStream of debug_bridge_user : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of debug_bridge_user : entity is "debug_bridge_user,bd_4611,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of debug_bridge_user : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of debug_bridge_user : entity is "bd_4611,Vivado 2022.1";
end debug_bridge_user;

architecture STRUCTURE of debug_bridge_user is
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of inst : label is "debug_bridge_user.hwdef";
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of S_BSCAN_bscanid_en : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN BSCANID_EN";
  attribute X_INTERFACE_INFO of S_BSCAN_capture : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN CAPTURE";
  attribute X_INTERFACE_INFO of S_BSCAN_drck : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN DRCK";
  ...
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_4611_clk, INSERT_VIP 0";
begin
inst: entity work.debug_bridge_user_bd_4611
     port map (
