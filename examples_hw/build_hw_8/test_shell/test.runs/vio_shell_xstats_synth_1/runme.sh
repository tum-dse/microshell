...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/vio_shell_xstats_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_shell_xstats.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_shell_xstats.tcl
