...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/design_ctrl_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ctrl_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ctrl_xbar_0.tcl
