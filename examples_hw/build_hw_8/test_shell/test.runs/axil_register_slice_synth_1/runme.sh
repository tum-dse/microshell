...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/axil_register_slice_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axil_register_slice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axil_register_slice.tcl
