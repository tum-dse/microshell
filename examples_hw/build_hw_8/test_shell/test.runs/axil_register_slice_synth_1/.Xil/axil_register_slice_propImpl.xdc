set_property SRC_FILE_INFO {cfile:/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.gen/sources_1/ip/axil_register_slice/axil_register_slice_clocks.xdc rfile:../../../test.gen/sources_1/ip/axil_register_slice/axil_register_slice_clocks.xdc id:1 order:LATE scoped_inst:inst} [current_design]
