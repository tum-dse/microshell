...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shell_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shell_top.tcl
