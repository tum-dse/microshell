...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/dyn_crossbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dyn_crossbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dyn_crossbar_0.tcl
