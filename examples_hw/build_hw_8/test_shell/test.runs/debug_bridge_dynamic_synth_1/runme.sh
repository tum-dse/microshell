...
HD_PWD='/scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.runs/debug_bridge_dynamic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debug_bridge_dynamic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debug_bridge_dynamic.tcl
