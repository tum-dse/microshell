...
--               /scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.gen/sources_1/bd/design_ctrl/ip/design_ctrl_clk_wiz_0_0/design_ctrl_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : design_ctrl_clk_wiz_0_0
...
entity design_ctrl_clk_wiz_0_0_clk_wiz is
  port (
...
end design_ctrl_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of design_ctrl_clk_wiz_0_0_clk_wiz is
  signal clk_in1_design_ctrl_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_design_ctrl_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_design_ctrl_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_design_ctrl_clk_wiz_0_0 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_ctrl_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_ctrl_clk_wiz_0_0 : entity is true;
end design_ctrl_clk_wiz_0_0;

architecture STRUCTURE of design_ctrl_clk_wiz_0_0 is
begin
inst: entity work.design_ctrl_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
