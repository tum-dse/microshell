...
-- Date        : Wed Nov 27 16:24:49 2024
-- Host        : amy running 64-bit NixOS 24.05 (Uakari)
-- Command     : write_vhdl -force -mode funcsim
--               /scratch/anubhav/Coyote/examples_hw/build_hw_8/test_shell/test.gen/sources_1/ip/debug_bridge_dynamic/debug_bridge_dynamic_sim_netlist.vhdl
-- Design      : debug_bridge_dynamic
...
entity debug_bridge_dynamic_bd_2f3d is
  port (
  ...
  attribute HW_HANDOFF of debug_bridge_dynamic_bd_2f3d : entity is "debug_bridge_dynamic.hwdef";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of debug_bridge_dynamic_bd_2f3d : entity is "bd_2f3d";
end debug_bridge_dynamic_bd_2f3d;

architecture STRUCTURE of debug_bridge_dynamic_bd_2f3d is
  component debug_bridge_dynamic_bd_2f3d_bs_switch_0 is
  port (
    s_bscan_drck : in STD_LOGIC;
    s_bscan_reset : in STD_LOGIC;
    s_bscan_sel : in STD_LOGIC;
  ...
  end component debug_bridge_dynamic_bd_2f3d_bs_switch_0;
  component debug_bridge_dynamic_bd_2f3d_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  end component debug_bridge_dynamic_bd_2f3d_lut_buffer_0;
  component debug_bridge_dynamic_bd_2f3d_xsdbm_0 is
  port (
    update : in STD_LOGIC;
  ...
  end component debug_bridge_dynamic_bd_2f3d_xsdbm_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN bd_2f3d_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
begin
bs_switch: component debug_bridge_dynamic_bd_2f3d_bs_switch_0
     port map (
...
lut_buffer: component debug_bridge_dynamic_bd_2f3d_lut_buffer_0
     port map (
...
xsdbm: component debug_bridge_dynamic_bd_2f3d_xsdbm_0
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity debug_bridge_dynamic is
  port (
    clk : in STD_LOGIC;
    S_BSCAN_bscanid_en : in STD_LOGIC;
    S_BSCAN_capture : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of debug_bridge_dynamic : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of debug_bridge_dynamic : entity is "debug_bridge_dynamic,bd_2f3d,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of debug_bridge_dynamic : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of debug_bridge_dynamic : entity is "bd_2f3d,Vivado 2022.1";
end debug_bridge_dynamic;

architecture STRUCTURE of debug_bridge_dynamic is
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of inst : label is "debug_bridge_dynamic.hwdef";
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of S_BSCAN_bscanid_en : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN BSCANID_EN";
  attribute X_INTERFACE_INFO of S_BSCAN_capture : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN CAPTURE";
  attribute X_INTERFACE_INFO of S_BSCAN_drck : signal is "xilinx.com:interface:bscan:1.0 S_BSCAN DRCK";
  ...
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN bd_2f3d_clk, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m0_bscan_bscanid_en : signal is "xilinx.com:interface:bscan:1.0 m0_bscan BSCANID_en";
  attribute X_INTERFACE_INFO of m0_bscan_capture : signal is "xilinx.com:interface:bscan:1.0 m0_bscan CAPTURE";
  attribute X_INTERFACE_INFO of m0_bscan_drck : signal is "xilinx.com:interface:bscan:1.0 m0_bscan DRCK";
  attribute X_INTERFACE_INFO of m0_bscan_reset : signal is "xilinx.com:interface:bscan:1.0 m0_bscan RESET";
  ...
  attribute X_INTERFACE_INFO of m0_bscan_update : signal is "xilinx.com:interface:bscan:1.0 m0_bscan UPDATE";
begin
inst: entity work.debug_bridge_dynamic_bd_2f3d
     port map (
