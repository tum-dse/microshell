...
int main(int argc, char *argv[])
{
    ...
    // SVM consumes one classification per 32 floats (128 bytes).
    constexpr uint32_t min_chunk_bytes = 32 * sizeof(float);
    ...
    uint32_t num_classifications = num_floats / 32;
    ...
    try {
        ...
        // Decode IEEE-754 bit patterns of canonical class outputs (1.0..5.0)
