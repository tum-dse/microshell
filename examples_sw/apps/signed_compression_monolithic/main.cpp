...
// AAAABBBB...PPPP pattern; on the monolithic side this compresses 2:1 (16
// pairs × 2 bytes = 32 out of 64 input bytes per chunk).
...
int main(int argc, char *argv[]) {
    ...
    uint32_t expected_rle_compressed = input_chunks * 32;
