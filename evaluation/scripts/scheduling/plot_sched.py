...
# ===== DATA LOADING =====
data1 = pandas.read_csv("../../data/scheduling/sched_latency.csv")
data2 = pandas.read_csv("../../data/scheduling/sched_reconfig.csv")
data3 = pandas.read_csv("../../data/scheduling/sched_resp_avg.csv")
data4 = pandas.read_csv("../../data/scheduling/sched_resp_95.csv")
data5 = pandas.read_csv("../../data/scheduling/sched_deadline.csv")
...
# ===== SAVE AND DISPLAY =====
plt.savefig("../../plots/scheduling/sched.png", dpi=300, bbox_inches='tight')
plt.savefig("../../plots/scheduling/sched.pdf", bbox_inches='tight')
plt.show()